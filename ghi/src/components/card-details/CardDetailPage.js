                      ...
                      {"flavor_text" in card.card_faces[1] ? (
                        <p className="fst-italic">
                          <ParseSymbolsAndLineBreaks
                            string={card.card_faces[1].flavor_text}
                          />
                        </p>
                      ) : (
                        <React.Fragment />
              ...
              <div className="card-body">
                ...
                {Object.keys(card).includes("card_faces") ? (
                  <React.Fragment>
                    ...
                    <p>
                      <ParseSymbolsAndLineBreaks
                        string={card.card_faces[0].oracle_text}
                      />
                    </p>
                    ...
                    <p>
                      <ParseSymbolsAndLineBreaks
                        string={card.card_faces[1].oracle_text}
                      />
                    </p>
                  ...
                  <React.Fragment>
                    <p>
                      <ParseSymbolsAndLineBreaks string={card.oracle_text} />
                    </p>
                    ...
                    <tbody>
                      <tr key="mana cost row">
                        ...
                        {Object.keys(card).includes("card_faces") ? (
                          <td>
                            <ParseSymbolsAndLineBreaks
                              string={card.card_faces[0].mana_cost}
                            />
                          </td>
                        ) : (
                          <td>
