  ...
  if (filteredCollection.length === 0){
    return(
      ...
      <div className="container" >
        ...
        <Link to="/edit_collection" className="right_side">Edit collection</Link>
      ...
      <div>
      <Container fluid="md" className="table-wrapper-scroll-y" style={{
                  padding: "25px",
                  ...
                  <Link to="/game"><b className="right_side">.</b></Link>
                ...
                <Col key ={row.multiverse_id} >
                    <Card className="bg-white rounded shadow d-block mx-auto mb-4" style={{ width: '15rem' }}>
                        <Carousel>
                            ...
                            <Carousel.Item>
                                <Card.Img variant="top" src={row.back_picture_url}/>
                            </Carousel.Item>   
                        </Carousel>
                            <Card.Body>
                                <Card.Title>{row.name}</Card.Title>
                                    <Card.Text>
                                        ...
                                        <Link to= {`/card/${row.multiverse_id}`}>See card details</Link>
                                    </Card.Text>
                            </Card.Body>
                      </Card>
                </Col>
